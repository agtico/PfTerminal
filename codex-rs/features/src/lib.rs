...
pub enum Feature {
    ...
    CurrentTimeReminder,
    /// Compatibility flag for the released standalone input-interruptible sleep tool.
    SleepTool,
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while PFTerminal is running a thread.",
