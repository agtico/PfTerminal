...
client_request_definitions! {
    ...
    #[experimental("thread/spawnAgent")]
    ThreadSpawnAgent => "thread/spawnAgent" {
        params: v2::ThreadSpawnAgentParams,
        inspect_params: true,
    ...
    ThreadTurnsItemsList => "thread/turns/items/list" {
        ...
        // Compatibility alias over the same append-only item store.
        serialization: None,
