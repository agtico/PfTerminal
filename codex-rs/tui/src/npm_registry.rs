...
pub(crate) const PACKAGE_URL: &str = "https://registry.npmjs.org/@agticorp%2fpfterminal";
    ...
    fn version_json(version: &str) -> serde_json::Value {
        serde_json::json!({
            "dist": {
                ...
                "tarball": format!("https://registry.npmjs.org/@agticorp/pfterminal/-/pfterminal-{version}.tgz"),
            }
        })
    }
